      ...
      <div className="container mx-auto px-4 py-12">
              ...
              <ul className="space-y-3">
                {category.links.map((link) => (
                  <li key={link.name}>
                    <Link 
                      to={link.to} 
                      className={`text-sm hover:underline hover:${
        ...
        <div className="mt-12 border-t pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex items-center space-x-2">
            <Link to="/" className={`text-2xl font-bold ${theme === 'dark' ? 'text-primary-300' : 'text-primary-600'}`}>
              EdHub
            </Link>
          ...
          <div className="flex space-x-6">
            <a href="https://twitter.com" aria-label="Twitter" className="hover:text-primary-600">
            ...
            <a href="https://github.com" aria-label="GitHub" className="hover:text-primary-600">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://linkedin.com" aria-label="LinkedIn" className="hover:text-primary-600">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
